 ...
 if (!empty($_POST)) {
   ...
   if(isset($_POST['creation']))
   {
    ...
    elseif (grapheme_strlen($titre)> 50) {
       $err_titre="Le titre doit faire moins de 51 caracteres(".grapheme_strlen($titre)."/50)"; 
      $valid=false;
    }
        ...
        <div class="col-6">
                ...
                <form method="post">
                  ...
                  <label  class="form-label">Titre</label>
                   <input type="text" class="form-control" name="titre"  placeholder="Titre" value="<?php if(isset($titre)){echo $titre;} ?>">
                 </div>
                 <div class="mb-3">
               ...
               <div class="mb-3">
                <?php if(isset($err_contenu)){echo '<div>'.$err_contenu.'</div>';} ?>
                  ...
                  <textarea name="contenu" class="form-control" cols="30" rows="5" placeholder="Votre topic ...." value="<?php if(isset($contenu)){echo $contenu;} ?>"></textarea>
                
               </div>
              
                   <div class="mb-3">     
                       <button type="submit" class="btn btn-primary"  name="creation">Créer votre topic</button>
                   </div>
                </form>
            </div>
